...
//        santaClaus.children = new ArrayList<>();
    ...
    public void update(final Input input, final int index) {
        ...
        strategy = input.getAnnualChanges().get(index).getStrategy();
    ...
    public AnnualChildren santaAction(final Input input) {
        ...
        for (int i = 0; i <= input.getNumberOfYears(); i++) {
            ...
            Sort sorter = sortFactory.createSorter(strategy);
            ...
            yellowElf.setChildren(childrenList);
            yellowElf.elfAction();
            SortById sortById = new SortById();
            sortById.sortChildren(childrenList);
