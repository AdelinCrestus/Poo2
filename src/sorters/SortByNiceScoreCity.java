...
public final class SortByNiceScoreCity implements Sort {
    ...
    public void setMapCityScores(final HashMap<Cities, ArrayList<Double>> mapCityScores) {
        this.mapCityScores = mapCityScores;
    }

    public void setMapCityScore(final HashMap<Cities, Double> mapCityScore) {
